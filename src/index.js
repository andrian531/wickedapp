...
//import Landing from './components/landing' orignya
import Landing from './components/layouts/wicked/main'
...
import Pets from './components/layouts/wicked/main';
					...
					<ScrollContext>
						<Switch>
                            ...
                            <Layout>
								...
								{/*Blog Pages*/}
                                <Route path={`${process.env.PUBLIC_URL}/bookings/cheap-campervan-hire-australia`} component={RightSide}/>
                                <Route path={`${process.env.PUBLIC_URL}/bookings/details`} component={Details}/>
                                <Route path={`${process.env.PUBLIC_URL}/bookings/booking-page`} component={BlogPage}/>
