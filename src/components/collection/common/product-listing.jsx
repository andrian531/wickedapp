    ...
    render (){
        ...
        return (
            <div>
                       ...
                       <div className="hotel-card-list-desktop roduct-wrapper-grid list-view">
                        ...
                        {products.length > 0 ?
                            ...
                            >
                                    ...
                                    { products.slice(0, this.state.limit).map((product, index) =>
                                        <div className={`${this.props.colSize===3?'search-list-item recentlyViewlist':'col-lg-'+this.props.colSize}`} key={index}>
