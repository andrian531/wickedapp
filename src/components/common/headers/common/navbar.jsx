                    ...
                    <div id="mainnav" >
                        ...
                        <ul className="nav-menu" style={this.state.navClose}>
                            ...
                            <li>
                                ...
                                <Link to={`${process.env.PUBLIC_URL}/bookings/cheap-campervan-hire-australia`} >{('Bookings')}  <span className="sub-arrow"></span></Link>
                                
                                <ul className="nav-submenu">
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('category_left_sidebar')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('category_right_sidebar')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('category_no_sidebar')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('category_metro')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('category_full_width')}</Link></li>
                                </ul>
                            ...
                            <li >
                                ...
                                {/*
                                <ul className="nav-submenu">
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('left_sidebar')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('right_sidebar')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('no_sidebar')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('three_col_thumbnail_left')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('three_col_thumbnail_right')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('thumbnail_below')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('thumbnail_left')}</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('thumbnail_right')}</Link></li>
                                </ul>
                                */}
                            </li>
                                        ...
                                        <div className="row">
                                            <div className="col mega-box">
                                                <div className="link-section">
                                                    ...
                                                    <div className="menu-content">
                                                        <ul>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('portfolio_grid_2')}</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('portfolio_grid_3')}</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('portfolio_grid_4')}</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('portfolio_masonary_2')}</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('portfolio_masonary_3')}</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('portfolio_masonary_4')}</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('portfolio_masonary_full')}</Link></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col mega-box">
                                                <div className="link-section">
                                                    ...
                                                    <div className="menu-content">
                                                        <ul>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('element_title')}</Link></li>
                                                            <li><Link to={`${process.env.PUBLIC_URL}/`} >{translate('collection_banner')}</Link></li>
                            ...
                            <li>
                                ...
                                <ul className="nav-submenu">
                                    <li><Link to={`${process.env.PUBLIC_URL}/pages/about-us`} >New South Wales</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/pages/404`} >Queensland</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/pages/lookbook`} >Victoria</Link></li>
                                    <li><Link to={`${process.env.PUBLIC_URL}/pages/login`} >Northern Territory</Link></li>
